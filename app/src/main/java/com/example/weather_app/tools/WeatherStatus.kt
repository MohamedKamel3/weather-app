...
fun getWeatherStatus(code: Int, time24: String): Triple<String, Int, Int> {
    ...
    val weatherImageMap = mapOf(
        ...
        1100 to Pair(
            R.drawable.a11000_mostly_clear_small2x, R.drawable.a11001_mostly_clear_small2x
        ),
        1101 to Pair(
            R.drawable.a11010_partly_cloudy_small2x, R.drawable.a11011_partly_cloudy_small2x
        ),
        1102 to Pair(
            R.drawable.a11020_mostly_cloudy_small2x, R.drawable.a11021_mostly_cloudy_small2x
        ),
    ...
    val weatherBigImageMap = mapOf(
        ...
        1100 to Pair(
            R.drawable.b11000_mostly_clear_large2x, R.drawable.b11001_mostly_clear_large2x
        ),
        1101 to Pair(
            R.drawable.b11010_partly_cloudy_large2x, R.drawable.b11011_partly_cloudy_large2x
        ),
        1102 to Pair(
            R.drawable.b11020_mostly_cloudy_large2x, R.drawable.b11021_mostly_cloudy_large2x
        ),
    ...
    val (daybImage, nightbImage) = weatherImageMap[code] ?: Pair(null, null)
